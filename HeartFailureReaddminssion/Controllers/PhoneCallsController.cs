...
namespace HeartFailureReaddminssion.Controllers
{
    public class PhoneCallsController : Controller
    {
        ...
        {
            var phoneCalls = db.PhoneCalls.Include(p => p.Patient);
        ...
        public ActionResult Create([Bind(Include = "ID,PatientId,CallsMade,LastCallDate,FirstCallUser,PatientReached,PatientResponse")] PhoneCall phoneCall)
        {
            ...
            ViewBag.PatientId = new SelectList(db.Patients, "ID", "FirstName", phoneCall.PatientId);
            return View(phoneCall);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,PatientId,CallsMade,LastCallDate,FirstCallUser,PatientReached,PatientResponse")] PhoneCall phoneCall)
        {
            if (ModelState.IsValid)
            {
